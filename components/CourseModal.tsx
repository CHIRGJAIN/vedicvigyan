...
import { X, Clock, Users, Star, DollarSign, CheckCircle } from 'lucide-react'
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-start justify-between p-6 border-b">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">{course.duration} • {course.students} students • Rating: {course.rating}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <ul className="text-sm text-gray-700 space-y-2">
                ...
                <li className="flex items-center space-x-2"><Users size={14} /> <span>{course.students} students enrolled</span></li>
                <li className="flex items-center space-x-2"><Star size={14} /> <span>Rating: {course.rating}</span></li>
              </ul>
            </div>
          </div>
