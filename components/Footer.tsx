        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-20 aspect-square rounded-full bg-white flex items-center justify-center shadow-lg ring-2 ring-white/60 overflow-hidden flex-shrink-0">
                <Image
                  src="/vves-logo(1).png"
                  alt="VVES logo"
                  width={80}
      ...
      <div className="bg-black/20 py-3">
        <div className="container-custom text-center">
          <div className="flex items-center justify-center space-x-3">
            <div className="w-10 aspect-square rounded-full bg-white overflow-hidden shadow ring-1 ring-white/50 flex items-center justify-center">
              <Image
                src="/vves-logo(1).png"
                alt="VVES logo"
                width={40}
